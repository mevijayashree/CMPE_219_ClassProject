...
class Transition {
    ...
    render() {
        ...
        if(this.roundNumber === 3 && this.roundScore <= decent) {
        ...
        } else if(this.roundNumber === 3 && this.roundScore <= good) {
            ...
            userArrayParse[2] = 1;
            userArrayParse[3] = 0;
        } else if(this.roundNumber === 3 && this.roundScore <= best) {
